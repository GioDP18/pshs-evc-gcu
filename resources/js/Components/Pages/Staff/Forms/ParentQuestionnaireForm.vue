    ...
    <div class="main-content">
        <div class="column-1">
            <div class="table-card">
                ...
                <table id="table-pqf" class="table table-striped table-hover" width="100%">
                    <thead>
                        <tr>
                            <th>Campus</th>
...
onMounted(async () => {
    initializeDataTable();
    getAllParentQuestionnaireForms();
    getAllUsers();
});
...
const getAllParentQuestionnaireForms = async () => {
    try {
        const resp = await axios.get(`${import.meta.env.VITE_BASE_URL}/api/v1/get-all-parent-questionnaire-forms`)
...
const goToRequests = () => {
    router.push({ name: 'staff-requestParentQuestionnaire' })
}
</script>
